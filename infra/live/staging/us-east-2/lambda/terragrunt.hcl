  ...
  functions = {
    ...
    "internal-router" = {
      ...
      environment = {
        ...
        FUNCTION_MAP = jsonencode({
          ...
          "insert-ppu-data-staging"    = "arn:aws:lambda:${local.aws_region}:${local.aws_account}:function:insert-ppu-data"
        })
        LOG_LEVEL = "INFO"
      }
      tags = {
    ...
    "insert-ppu-data" = {
      ...
      vpc_config = {
        ...
        security_group_ids = ["sg-0cb4d7360eb9f9b4a"] # Staging environment security group
      }
      environment = {
        ENVIRONMENT    = local.environment
        DB_ENDPOINT    = "bwppudb.cluster-cibvsppk6iez.us-east-2.rds.amazonaws.com" # Staging RDS endpoint
        DB_PORT        = "5432"
        DB_USER        = "brainsway"
        DB_PASSWORD    = "brainswaypwd"
        DB_NAME        = "bwppudb"
        DYNAMODB_TABLE = "event_log-staging" # Staging DynamoDB table
      }
      tags = {
        Environment = local.environment
    ...
    "software-update-handler" = {
      ...
      environment = {
        ENVIRONMENT    = local.environment
        DYNAMODB_TABLE = "sw_update-staging" # Staging DynamoDB table
    ...
    "lambda-test-runner" = {
      ...
      environment = {
        ...
        TEST_S3_BUCKET = "bw-lambda-test-reports-staging" # Staging-specific bucket
